(function(e) {
    ...
    e("body").append('<div id="zoom"><a class="close"></a><a href="#previous" class="previous"></a><a href="#next" class="next"></a><div class="content loading"></div><div class ="comment"><p>666666</p></div></div>');
    var t = e("#zoom").hide(),
    n = e("#zoom .content"),
    r = false,
    i = null,
